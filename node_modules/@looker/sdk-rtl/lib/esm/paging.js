...
export var LinkHeader = 'Link';
export var TotalCountHeader = 'X-Total-Count';
export var linkHeaderParser = linkHeader => {
...
export function pager(_x, _x2, _x3) {
...
export function pageAll(_x4, _x5) {
  ...
  getRel(name, limit, offset) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        _this3.items = yield sdkOk(_this3.transport.parseResponse(raw));
        result = {
          ok: true,
          value: _this3.items
        };
