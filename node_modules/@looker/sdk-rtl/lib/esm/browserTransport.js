...
import { trace, LookerAppId, agentPrefix, responseMode, ResponseMode, safeBase64, isErrorLike } from './transport';
...
export class BrowserTransport extends BaseTransport {
  ...
  initRequest(method, path, body, authenticator, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var agentTag = ((_options = options) === null || _options === void 0 ? void 0 : _options.agentTag) || agentPrefix;
