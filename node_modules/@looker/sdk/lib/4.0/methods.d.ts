...
export declare class Looker40SDK extends APIMethods implements ILooker40SDK {
    ...
    configuration_force_refresh(options?: Partial<ITransportSettings>): Promise<SDKResponse<any, IError | IValidationError>>;
    ...
    connection_databases(connection_name: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<string[], IError>>;
